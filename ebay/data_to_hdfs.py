...
HDFS_OUTPUT_DIR = '/ebay_data/' # Path in HDFS where data will be stored
HDFS_OUTPUT_FILENAME = 'data_ebay.csv' # Name of the CSV file in HDFS

local_csv_path='C:\\Users\\rahul\\OneDrive\\Desktop\\Data engineering 1\\data_ebay\\ebay_extracted_products_data.csv'
