...
HDFS_OUTPUT_DIR = '/newegg_data/data' # Path in HDFS where data will be stored
HDFS_OUTPUT_FILENAME = 'data_newegg.csv' # Name of the CSV file in HDFS

local_csv_path='C:\\Users\\rahul\\OneDrive\\Desktop\\Data engineering 1\\data_newegg\\newegg_detailed_products.csv'
